// This file was converted from zod-message.json to TypeScript for type safety and IDE support.
...
export const zodMessages = {
  errors: {
    ...
    too_small: {
      ...
      date: {
        exact: '{{- minimum, datetime}}の日時である必要があります。',
    ...
    too_big: {
      ...
      date: {
        exact: '{{- maximum, datetime}}の日時である必要があります。',
